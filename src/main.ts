...
private setupSecurityRoutes(): void {
  ...
  private generateSwaggerSpec(type?: string): any {
    const swaggerDefinition = {
      openapi: "3.0.0",
      info: {
        title: "web rest api Fahrixyzzz",
        version: "2.0.0",
        description:
          type === "get"
            ? "Welcome to the Fahrixyzzz API, this is documentation for GET endpoints"
            : type === "post"
              ? "Welcome to the Fahrixyzzz API, this is documentation for POST endpoints"
              : "API Documentation for Fahrixyzzz",
        contact: { email: "nokosindo03@gmail.com" },
