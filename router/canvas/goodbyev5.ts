...
export default [
  {
    ...
    example:
      "?username=Zero%20Two&guildName=Fahrixyzzz%20Community&memberCount=219&avatar=https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg&background=https://i.ibb.co/4YBNyvP/mountain-sunset.jpg&quality=90",
    parameters: [
      {
        name: "username",
        in: "query",
