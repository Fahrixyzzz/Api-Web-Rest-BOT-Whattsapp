...
export default [
  {
    ...
    example:
      "backgroundURL=https://i.ibb.co.com/2jMjYXK/IMG-20250103-WA0469.jpg&avatarURL=https://avatars.githubusercontent.com/u/194286198?v=4&rankName=epik&rankId=0&requireExp=1000&level=10&name=Fahrixyzzz&exp=500",
    parameters: [
      {
        name: "backgroundURL",
        in: "query",
