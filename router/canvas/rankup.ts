...
export default [
  {
    ...
    example:
      "backgroundURL=https://i.ibb.co.com/2jMjYXK/IMG-20250103-WA0469.jpg&avatarURL=https://avatars.githubusercontent.com/u/194286198?v=4&fromLevel=0&toLevel=1&name=putu",
    parameters: [
      {
        name: "backgroundURL",
        in: "query",
